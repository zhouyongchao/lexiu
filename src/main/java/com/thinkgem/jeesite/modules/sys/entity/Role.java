...
public class Role extends DataEntity<Role> {
	...
	private Org user;		// 根据用户ID查询角色列表

//	private List<Org> userList = Lists.newArrayList(); // 拥有用户列表
...
//	public List<Org> getUserList() {
//		return userList;
//	}
//
//	public void setUserList(List<Org> userList) {
//		this.userList = userList;
//	}
//	
//	public List<String> getUserIdList() {
//		List<String> nameIdList = Lists.newArrayList();
//		for (Org user : userList) {
